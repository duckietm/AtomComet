...
class User extends Authenticatable
{
    ...
    {
        return $this->hasOne(Ban::class, 'user_id')->where('expire', '>', time());
    }
	...
	{
		return $this->friends()
			->select(['user_two_id', 'players.id', 'players.username', 'players.figure', 'players.motto', 'players.last_online'])
			->join('players', 'players.id', '=', 'user_two_id')
